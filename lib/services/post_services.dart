...
// Read all posts as stream
static Stream<List<Post>> getAllPosts(currentActivePenggunaId) {
  return _postsCollection.snapshots().asyncMap((snapshot) async {
    return await Future.wait(snapshot.docs.map((doc) async {
      Map<String, dynamic> data = doc.data() as Map<String, dynamic>;
       final isFavorite = await FavoriteServices.isPostFavoriteStream(currentActivePenggunaId, doc.id).first;
      return Post(
        id: doc.id,
        penggunaId: data['penggunaId'],
        title: data['title'],
