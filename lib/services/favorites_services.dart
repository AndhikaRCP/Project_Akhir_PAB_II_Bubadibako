...
class FavoriteServices {
  ...
  static Stream<List<String>> getFavoritePostsByIdStream(String userId) {
    ...
    _penggunasCollection.doc(userId).snapshots().listen(
  ...
  static Stream<List<String>> getFavoritePostsStreamById(String userId) {
    return _penggunasCollection.doc(userId).snapshots().map((snapshot) {
      if (snapshot.exists && snapshot.data() != null) {
        Map<String, dynamic> data = snapshot.data() as Map<String, dynamic>;
        List<dynamic> favoritedPosts = data['favorite'];
        print('Daftar postingan favorit diperoleh.');
