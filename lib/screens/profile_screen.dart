...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  final AuthServices _authServices = AuthServices(); // Tambahkan inisialisasi AuthServices
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: FutureBuilder<Map<String, dynamic>?>(
          future: _authServices.getCurrentUserData(), // Panggil metode untuk mendapatkan data pengguna
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              userData['email'], // Ganti dengan nama pengguna
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 32,
                            ...
                            Text(
                              userData['username'], // Ganti dengan username pengguna
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 24,
